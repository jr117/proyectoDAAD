...
<head>
	<title>
		Eliminacion de Verificacion <!-- QUE BORRARA -->
	</title>
</head>
<body>
	<form id="form1" name="form1" method="post" action="">
		<label>id verificacion</label> <!-- QUE PIDE -->
...
<?php 
	...
	if(isset($_POST['datoBorrar'])){
		...
		$Con= Conectar();
		$SQL = "DELETE FROM verificaciones WHERE idVerificacion = '$datoBorrar';"; //DE QUE TABLA Y CONDICION
